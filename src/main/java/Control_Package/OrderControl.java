...
import Model_Package.CustomerModel;
import Util_Package.DBconnection;
import Model_Package.OrderModel;
...
public class OrderControl {
    ...
    public static boolean insertOrder(int cusID, String amount, String order_date, String order_status) {
        ...
        try {
            con = Util_Package.DBconnection.getConnection();
    ...
    public static List<Model_Package.CustomerModel> getAllCustomers() {
        return Control_Package.CustomerControl.getAllCustomers();
    }
}